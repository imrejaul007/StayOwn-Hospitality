...
class BookingChannelService {
  async getChannelPerformanceAnalytics(filters = {}) {
    try {
      ...
      logger.error('Error in getChannelPerformanceAnalytics:', error);
      return {
        success: false,
  ...
  async getChannelComparisonMetrics(matchCriteria) {
    try {
      ...
      logger.error('Error in getChannelComparisonMetrics:', error);
      return [];
    }
  }
  ...
  async getOTAPerformanceMetrics(matchCriteria) {
    try {
      ...
      logger.error('Error in getOTAPerformanceMetrics:', error);
      return [];
    }
  }
  ...
  async getChannelROIAnalysis(filters = {}) {
    try {
      ...
      logger.error('Error in getChannelROIAnalysis:', error);
      return {
        success: false,
  ...
  async getChannelForecast(filters = {}) {
    try {
      ...
      logger.error('Error in getChannelForecast:', error);
      return {
        success: false,
  ...
  async getChannelCustomerSegmentation(filters = {}) {
    try {
      ...
      logger.error('Error in getChannelCustomerSegmentation:', error);
      return {
        success: false,
  ...
  async exportChannelReport(filters = {}) {
    try {
      ...
      logger.error('Error in exportChannelReport:', error);
      return {
        success: false,
