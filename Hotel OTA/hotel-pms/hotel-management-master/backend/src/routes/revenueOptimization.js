...
router.get('/kpis', async (req, res) => {
  try {
    ...
    logger.error('Failed to get revenue KPIs', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.get('/yield-analysis', async (req, res) => {
  try {
    ...
    logger.error('Failed to run yield analysis', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/pricing/calculate', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to calculate optimal rates', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/pricing/apply', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to apply pricing changes', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/pricing/automated', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to run automated pricing', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.get('/strategies', async (req, res) => {
  try {
    ...
    logger.error('Failed to get pricing strategies', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/strategies', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to create pricing strategy', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.put('/strategies/:strategyId', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to update pricing strategy', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.get('/forecasts', async (req, res) => {
  try {
    ...
    logger.error('Failed to get forecasts', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/forecasts/generate', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    while (currentDate <= end) {
      for (const roomType of roomTypes) {
        try {
          ...
          logger.error(`Failed to generate forecast for ${roomType.name}`, { date: currentDate, error: forecastError.message });
        }
      }
    ...
    logger.error('Failed to generate forecasts', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.get('/competitors', async (req, res) => {
  try {
    ...
    logger.error('Failed to get competitors', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.post('/competitors', validate(mutationBaselineSchema), async (req, res) => {
  try {
    ...
    logger.error('Failed to add competitor', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
...
router.get('/competitors/:competitorId/rates', async (req, res) => {
  try {
    ...
    logger.error('Failed to get competitor rates', { error: error.message });
    res.status(500).json({
      success: false,
      error: error.message
    });
