...
class AddOnServiceManager {
  ...
  async getUpsellRecommendations(bookingContext, maxRecommendations = 5) {
    try {
      ...
      logger.error('Error getting upsell recommendations:', error);
      throw error;
    }
  }
  ...
  async getPackageInclusions(packageId, bookingContext = {}) {
    try {
      ...
      logger.error('Error getting package inclusions:', error);
      throw error;
    }
  }
  ...
  async createInclusion(inclusionData) {
    try {
      ...
      logger.error('Error creating service inclusion:', error);
      throw error;
    }
  }
