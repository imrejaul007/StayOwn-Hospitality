...
class CRMAutomationService {
  async createOrUpdateGuestProfile(userId, hotelId, data = {}) {
    try {
      ...
      logger.error('Error creating/updating guest profile:', error);
      throw error;
    }
  }
  ...
  async updateGuestMetrics(profile) {
    try {
      ...
      logger.error('Error updating guest metrics:', error);
      throw error;
    }
  }
  ...
  async triggerAutomatedActions(userId, hotelId, behavior) {
    try {
      ...
      logger.error('Error triggering automated actions:', error);
    }
  }
  ...
  async getGuestInsights(userId, hotelId) {
    try {
      ...
      logger.error('Error getting guest insights:', error);
      throw error;
    }
  }
