...
exports.checkExpiringQRs = checkExpiringQRs;
exports.sendExpirationReminders = sendExpirationReminders;
exports.sendExpirationNotification = sendExpirationNotification;
exports.sendCheckinReminder = sendCheckinReminder;
exports.deactivateExpiredQRs = deactivateExpiredQRs;
 ...
 */
async function sendExpirationNotification(qr) {
    const result = {
        bookingId: qr.bookingId,
        email: false,
        whatsapp: false,
    ...
    if (qr.guestEmail) {
        try {
            await axios_1.default.post(`${EMAIL_SERVICE_URL}/api/send`, {
                to: qr.guestEmail,
                subject,
                message,
    ...
    if (qr.guestPhone) {
        try {
            await axios_1.default.post(`${WHATSAPP_SERVICE_URL}/api/send`, {
                to: qr.guestPhone,
                message,
                type: 'text',
            });
    ...
    if (qr.guestPhone) {
        try {
            await axios_1.default.post(`${SMS_SERVICE_URL}/api/send`, {
                to: qr.guestPhone,
...
async function sendCheckinReminder(bookingId) {
    const qr = await room_qr_1.RoomQR.findOne({ bookingId });
    if (!qr) {
        return false;
    }
 ...
 */
async function deactivateExpiredQRs() {
    const result = await room_qr_1.RoomQR.updateMany({
        isActive: true,
...
//# sourceMappingURL=qr-expiration-notifier.js.map