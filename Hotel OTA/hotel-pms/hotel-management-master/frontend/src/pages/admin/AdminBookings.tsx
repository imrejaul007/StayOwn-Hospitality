...
function AdminBookings() {
  ...
  // Fetch bookings (memoized to prevent unnecessary re-creation)
  ...
  }, [filters, selectedPropertyId, user?.hotelId]);
...
export default withErrorBoundary(AdminBookings, { level: 'page' });