...
// Exclude soft-deleted invoices from all find queries by default
...
invoiceSchema.index({ hotelId: 1, status: 1, issueDate: -1 }); // Compound index for revenue dashboard aggregation pipelines
