...
class OperationalManagementService {
  ...
  async updateCounterStatus(counterId, status, userId) {
    try {
      ...
      logger.error('Error updating counter status:', error);
      throw error;
    }
  }
  ...
  async createArrivalDepartureMode(modeData, userId) {
    try {
      ...
      logger.error('Error creating arrival/departure mode:', error);
      throw error;
    }
  }
  ...
  async updateArrivalDepartureMode(modeId, updateData, userId) {
    try {
      ...
      logger.error('Error updating arrival/departure mode:', error);
      throw error;
    }
  }
  ...
  async deleteArrivalDepartureMode(modeId, userId) {
    try {
      ...
      logger.error('Error deleting arrival/departure mode:', error);
      throw error;
    }
  }
  ...
  async claimLostFoundItem(itemId, claimedBy, notes, userId) {
    try {
      ...
      logger.error('Error claiming lost & found item:', error);
      throw error;
    }
  }
  ...
  async disposeLostFoundItem(itemId, notes, userId) {
    try {
      ...
      logger.error('Error disposing lost & found item:', error);
      throw error;
    }
  }
  ...
  async updateLostFoundItemLocation(itemId, newLocation, notes, userId) {
    try {
      ...
      logger.error('Error updating lost & found item location:', error);
      throw error;
    }
  }
  ...
  async getOperationalOverview(hotelId) {
    try {
      ...
      logger.error('Error getting operational overview:', error);
      throw error;
    }
  }
  ...
  async getCounterAnalytics(hotelId, dateRange) {
    try {
      ...
      logger.error('Error getting counter analytics:', error);
      throw error;
    }
  }
  ...
  async getLostFoundAnalytics(hotelId, dateRange) {
    try {
      ...
      logger.error('Error getting lost & found analytics:', error);
      throw error;
    }
  }
  ...
  async getExpiredLostFoundItems(hotelId) {
    try {
      ...
      logger.error('Error getting expired lost & found items:', error);
      throw error;
    }
  }
  ...
  async getValuableLostFoundItems(hotelId) {
    try {
      ...
      logger.error('Error getting valuable lost & found items:', error);
      throw error;
    }
  }
  ...
  async bulkUpdateCounterStatus(updates, userId) {
    ...
    try {
      ...
      logger.error('Error bulk updating counter status:', error);
      throw error;
    } finally {
      session.endSession();
    }
  ...
  async bulkDisposeExpiredItems(notes, userId) {
    try {
      ...
      logger.error('Error bulk disposing expired items:', error);
      throw error;
    }
  }
}
