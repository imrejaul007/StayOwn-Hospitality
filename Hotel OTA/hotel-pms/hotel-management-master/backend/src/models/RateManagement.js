...
const ratePlanSchema = new mongoose.Schema({
  ...
  rateGuardrails: {
    absoluteFloor: { type: Number, min: 0, default: 0 },
    absoluteCeiling: { type: Number, min: 0 },
    maxDailyChangePercent: { type: Number, min: 0, max: 100, default: 20 },
    enforcementMode: { type: String, enum: ['hard', 'soft', 'alert_only'], default: 'hard' }
  },
  mealPlan: {
    type: String,
