        ...
        try {
            ...
            try {
                ...
                if (inventoryItems.length > 0) {
                    ...
                    logger.debug(`Inventory integration completed: ${inventoryResults.processed.length} items processed, ${inventoryResults.reordersCreated.length} reorders created`);
                }
            } catch (inventoryError) {
                logger.error('Inventory integration failed:', inventoryError);
            ...
            logger.error('Failed to create financial impact:', error);
            throw error;
        }
    }
...
Please review the financial impact and take appropriate action.`,
            ...
            logger.error('Failed to send budget alert notifications:', error);
        }
    }
