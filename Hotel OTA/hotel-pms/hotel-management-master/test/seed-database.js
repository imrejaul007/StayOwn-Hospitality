...
import RoomAvailability from './backend/src/models/RoomAvailability.js';
import WebSettings from './backend/src/models/WebSettings.js';
import BookingFormTemplate from './backend/src/models/BookingFormTemplate.js';
import AuditLog from './backend/src/models/AuditLog.js';
import APIKey from './backend/src/models/APIKey.js';
import WebhookEndpoint from './backend/src/models/WebhookEndpoint.js';
import APIMetrics from './backend/src/models/APIMetrics.js';
...
async function createSeedData() {
  ...
  try {
    ...
    const hotel = new Hotel({
      ...
      isActive: true,
      ownerId: null // Will be set after creating owner user
    });
    ...
    // Update hotel with owner ID
    hotel.ownerId = ownerUser._id;
    await hotel.save();
