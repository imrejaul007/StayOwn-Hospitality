...
class GuestManagementService {
  ...
  async createAccountAttribute(attributeData, userId) {
    try {
      ...
      logger.error('Error creating account attribute:', error);
      throw error;
    }
  }
  ...
  async updateAccountAttribute(attributeId, updateData, userId) {
    try {
      ...
      logger.error('Error updating account attribute:', error);
      throw error;
    }
  }
  ...
  async deleteAccountAttribute(attributeId, userId) {
    try {
      ...
      logger.error('Error deleting account attribute:', error);
      throw error;
    }
  }
  ...
  async createGuestType(guestTypeData, userId) {
    try {
      ...
      logger.error('Error creating guest type:', error);
      throw error;
    }
  }
  ...
  async updateGuestType(guestTypeId, updateData, userId) {
    try {
      ...
      logger.error('Error updating guest type:', error);
      throw error;
    }
  }
  ...
  async deleteGuestType(guestTypeId, userId) {
    try {
      ...
      logger.error('Error deleting guest type:', error);
      throw error;
    }
  }
  ...
  async createIdentificationType(identificationTypeData, userId) {
    try {
      ...
      logger.error('Error creating identification type:', error);
      throw error;
    }
  }
  ...
  async updateIdentificationType(identificationTypeId, updateData, userId) {
    try {
      ...
      logger.error('Error updating identification type:', error);
      throw error;
    }
  }
  ...
  async deleteIdentificationType(identificationTypeId, userId) {
    try {
      ...
      logger.error('Error deleting identification type:', error);
      throw error;
    }
  }
  ...
  async validateGuestData(hotelId, guestData) {
    try {
      ...
      logger.error('Error validating guest data:', error);
      throw error;
    }
  }
  ...
  async getGuestManagementOverview(hotelId) {
    try {
      ...
      logger.error('Error getting guest management overview:', error);
      throw error;
    }
  }
  ...
  async duplicateGuestType(guestTypeId, newName, userId) {
    try {
      ...
      logger.error('Error duplicating guest type:', error);
      throw error;
    }
  }
  ...
  async bulkUpdateDisplayOrder(hotelId, updates, userId) {
    ...
    try {
      ...
      logger.error('Error bulk updating display order:', error);
      throw error;
    } finally {
      session.endSession();
    }
