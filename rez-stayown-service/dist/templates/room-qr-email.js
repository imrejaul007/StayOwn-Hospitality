...
exports.generateRoomQREmail = generateRoomQREmail;
exports.generateRoomQRTextEmail = generateRoomQRTextEmail;
exports.generateWhatsAppMessage = generateWhatsAppMessage;
function generateRoomQREmail(data) {
 ...
 */
function generateRoomQRTextEmail(data) {
    const formattedCheckIn = data.checkIn.toLocaleDateString('en-IN', {
        weekday: 'long',
        year: 'numeric',
        month: 'long',
...
//# sourceMappingURL=room-qr-email.js.map